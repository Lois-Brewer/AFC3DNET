...
parser.add_argument('--model_path', type=str, default="output/1681295396/model3D_last_ckpt.pth", help='path to model file')
...
# parser.add_argument('--data_path', type=str, default='LEVIR-CD256', help='test dataset')
parser.add_argument('--data_path', type=str, default='SYSU-CD/test')
...
# Test Summary
# Loss is 0.6750993132591248
# {'acc': 0.9909304678440085, 'iou': 0.8348446555417153, 'F1': 0.9099894079255578, 'precision': 0.9202593890955915, 'recall': 0.8999462369051021}

save_path = './results/SYSU-CD/test'
# textfile = 'E:\\AllData\\LEVERCD\\ABLabel\\list\\test.txt'
textfile = 'SYSU-CD/test/list/test.txt'
